...
gulp.task( 'scripts', function() {
    var scripts = [
        ...
        // Start - All owl carousel stuff
        paths.dev + '/js/owl/owl.carousel.min.js', 
...
////////////////// Owl Assets /////////////////////////
// Copy all JS files
   gulp.src( paths.node + 'owl.carousel/dist/owl.carousel.min.js' )
        .pipe( gulp.dest( paths.dev + '/js/owl' ) );

// Copy all owl SCSS files
    gulp.src( paths.node + 'owl.carousel/src/scss/*.scss' )
        .pipe( gulp.dest( paths.dev + '/sass/owl' ) );
