...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login col-md-6 mx-auto" method="post">
			...
			<p class="form-row">
				...
				<button type="submit" class="btn btn-primary btn-lg" name="login" value="<?php esc_attr_e( 'Log in', 'understrap' ); ?>"><?php esc_html_e( 'Log in', 'understrap' ); ?></button>
	...
	<div class="u-column2 col-md-6">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="woocommerce-FormRow form-row">
				...
				<button type="submit" class="btn btn-primary btn-lg" name="register" value="<?php esc_attr_e( 'Register', 'understrap' ); ?>"><?php esc_html_e( 'Register', 'understrap' ); ?></button>
			</p>
